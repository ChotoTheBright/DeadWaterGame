...
@onready var int_warp = $stuff/HouseInterior/WarpSpotInt
@onready var ext_warp = $stuff/Houses/playerhouse/WarpSpotExt
...
func door_transit(interior: int): #for the other houses
	anim_player.play_backwards("fade")
	match interior:
		0: #enter
			emit_signal("enter_bldg")
